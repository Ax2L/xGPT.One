...
# Add the API key parameter to load_env function
def load_env(openai_api_key: str, model_name: str, temperature: float) -> None:
    # Replace the hardcoded API key with the parameter
...
Your task is to add English comments to Python code. You are not allowed to modify the code!
