...
height = st.slider("Height of loader (px):",  min_value=1, value=4, step=1)
width_percent = st.slider("Width of loader (%):", min_value=1, value=100, step=1)
duration = st.slider("Animation time (sec):", min_value=0.1, value=0.7, step=0.1)
# Show the loader

spinner_custom_line(height,width_percent,duration)
