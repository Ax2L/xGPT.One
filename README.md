...
![Visitor Count](https://visitor-badge.glitch.me/badge?id=Ax2L.visitor-badge)
...
7. Navigate to git-lfs.github.com and click Download.[](https://git-lfs.com)\*\*\*\*
...
8. On your computer, locate and unzip the downloaded file.

9. Open the terminal or Git Bash.

10. Change the current working directory to the folder you downloaded and unzipped.
...
11. To install this file, run the following command:
...
13. If a success message for `git lfs install` does not appear, please contact [GitHub Support](https://support.github.com/contact?tags=docs-generic). Make sure to include the name of your operating system.
