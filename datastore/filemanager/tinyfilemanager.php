...
$auth_users = array(
    'admin' => '$2y$10$qdvGMhdgdtH4pqy78hXmzeENriDFPVlLDxc6Z8rVLA0IDMZ/Bw1M2',
    //changeme
...
$favicon_path = 'http://127.0.0.1:8334/data/images/logo/favicon-32x32.png';
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            body.theme-dark { background-image: linear-gradient(90deg, #1e2a38, #0a111f); color: #CFD8DC; }
            ...
            .theme-dark .btn-outline-primary { color: #DDDDDD; border-color: #2a3544; }
            .theme-dark .btn-outline-primary:hover, .theme-dark .btn-outline-primary:active { background-color: #202024;}
